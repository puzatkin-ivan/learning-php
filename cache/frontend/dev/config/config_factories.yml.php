...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'W:\\!git\\service-encyclopedia\\log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'W:\\!git\\service-encyclopedia\\cache\\frontend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'W:\\!git\\service-encyclopedia\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'W:\\!git\\service-encyclopedia\\cache\\frontend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'W:\\!git\\service-encyclopedia\\apps\\frontend/template',
)));
