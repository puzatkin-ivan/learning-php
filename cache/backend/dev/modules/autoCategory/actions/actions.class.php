...
class autoCategoryActions extends sfActions
{
  ...
  public function executeFilter(sfWebRequest $request)
  {
    ...
    if ($request->hasParameter('_reset'))
    {
      ...
      $this->redirect('@categories_category');
    }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoiceMany(array('model' => 'Categories'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      if ($request->hasParameter('_save_and_add'))
      {
        ...
        $this->redirect('@categories_category_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'categories_category_edit', 'sf_subject' => $categories));
      }
    }
    else
    {
