...
class sfRoute implements Serializable
{
    ...
    protected function initializeOptions()
    {
        ...
        $this->options['variable_prefix_regex'] = '(?:' . implode('|', array_map($callback, $this->options['variable_prefixes'])) . ')';
        $this->options['segment_separators_regex'] = '(?:' . implode('|', array_map($callback, $this->options['segment_separators'])) . ')';
